...
const PlanTable = () => {
    ...
    useEffect(() => {
        ...
        async function fetching() {
            ...
            const responsetable = await axios.get(`${API_CONFIG.BASE_URL}/get_subscription_plan/` + encryptedCode, userId, {
                headers: {
    ...
    return (
        <div>
            <br />
            <h2 style={{ textAlign: "center" }}>Payment Tracking</h2>
            <br />
